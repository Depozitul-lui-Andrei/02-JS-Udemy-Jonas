...
// Every method
// returns true if every element in the array satisfy the condition that we pass in
...
console.log(arr.flat()); // all numbers are in one array

const arrDeep = [[[1, 2], 3], [4, [5, 6]], 7, 8];
console.log(arrDeep.flat(1)); // 1 depth is default
...
// flatMap - map and flat combined, but flat goes only 1 level deep and can't be changed
